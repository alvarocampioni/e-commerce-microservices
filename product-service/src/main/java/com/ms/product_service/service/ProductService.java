...
public class ProductService {
    ...
    @Autowired
    public ProductService(ProductRepository productRepository, ProductCacheService productCacheService, CacheManager cacheManager) {
    ...
    public ProductResponse addProduct(ProductRequest productRequest, String role) {
        ...
        return productCacheService.mapProductToResponse(productRepository.save(product));
    }
    ...
    public ProductResponse updateProduct(String id, ProductRequest productRequest, String role) {
        ...
        return productCacheService.mapProductToResponse(updatedProduct);
    }
    ...
    public void deductProduct(OrderDTO orderDTO) {
